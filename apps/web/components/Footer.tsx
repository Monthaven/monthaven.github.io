      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-6 px-6 py-10 text-sm text-[var(--mh-charcoal)]">
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
          <div className="space-y-2">
            <p className="text-lg font-semibold text-[var(--mh-charcoal-900)]">Monthaven Capital Inc.</p>
            <p>Confidential advisory for real assets. Mandate-driven sourcing and execution.</p>
            <p className="text-xs text-[var(--mh-sage700)]">30 N Gould St Ste R · Sheridan, WY 82801</p>
          </div>
          <div className="flex flex-wrap gap-4 text-sm">
            ...
            <Link href="mailto:info@monthavencapital.com">info@monthavencapital.com</Link>
            <Link href="mailto:legal@monthavencapital.com">legal@monthavencapital.com</Link>
        ...
        <p className="text-xs text-[var(--mh-sage700)]">© {year} Monthaven Capital Inc. All rights reserved.</p>
      </div>
    </footer>
  );
}
